...
import logo from './assets/launologo.jpg';
...
export default function App() {
  ...
  const url = "https://backend.sib-2000.com.ar/bragadouno";
  ...
  const handleOpenEmail = () => {
    Linking.openURL('mailto:launoradio@gmail.com')
  }
      ...
      <ImageBackground source={logo} style={styles.backgroundImage}>
        <View style={styles.overlay}>
          <View style={styles.header}>
            <Text style={styles.headerTitle}>La Uno Radio</Text>
            <Menu
              visible={menuVisible}
              onDismiss={closeMenu}
              anchor={
              ...
              <Menu.Item onPress={() => handlePressButtonAsync('https://www.facebook.com/oscar.zacarias.355744?mibextid=ZbWKwL')} title="Visite nuestro Facebook" />
              <Menu.Item onPress={() => handlePressButtonAsync('https://www.instagram.com/launoradio?igsh=MWViMTFia3ZnOHRpOQ==')} title="Visite nuestro Instagram" />
          ...
          <View style={styles.controlsContainer}>
            <View style={styles.radioInfo}>
              <Text style={styles.radioName}>La Uno</Text>
              <Text style={styles.radioLocation}>La Uno Radio - Bragado</Text>
            </View>
